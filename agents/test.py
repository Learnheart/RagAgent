...
def test_retrieval_with_dataset(test_data_path='C:\\VNUIS_Workspace\\RagAgent\\data\\retrieval_data.json', output_file='test_results.csv'):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='test_results.csv', help='File kết quả đầu ra')
